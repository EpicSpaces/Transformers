    ...
    for det in detectors:
        if det == chunk['det']:
            prior = JointDistribution(variable,
                                    ...
                                    Uniform(
                                        distance=(10, 100),
                                        tc=(results[det][chunk['chunk']]['peak_time']-.2, results[det][chunk['chunk']]['peak_time']+0.2),
                                        )
                                    )
            ...
            output_path = os.path.join(script_dir, f"./{p_tmp}_plots/html_inference_plots/distance_estimation_plots/distance_estimation_plots_{safe_chunk}_{det}.html")
